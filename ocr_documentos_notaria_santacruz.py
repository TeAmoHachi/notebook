...
# ═══════════════════════════════════════════════════════════════════════
# PASO 2: INSTALAR DEPENDENCIAS + REINICIAR KERNEL
# ═══════════════════════════════════════════════════════════════════════
...
print("\n🔧 PASO 1: Instalando NumPy 1.26.4 (compatible)...")
!pip install -q "numpy<2.0" --force-reinstall
print("   ✅ NumPy downgraded a 1.x")

# ═══════════════════════════════════════════════════════════════════════
# PASO 2: Instalar PaddlePaddle
# ═══════════════════════════════════════════════════════════════════════

print("\n🔧 PASO 2: Instalando PaddlePaddle-GPU...")
...
print("\n🔄 REINICIANDO KERNEL para aplicar cambios de NumPy...")
print("   ⏱️ Se reiniciará en 3 segundos...")
print("\n💡 DESPUÉS DEL REINICIO:")
print("   1. Ejecuta la celda 1 (Verificar GPU)")
print("   2. Ejecuta la CELDA 2B (verificación - está abajo)")
print("   3. Ejecuta la celda 3 (Inicializar OCR)")
...
# ═══════════════════════════════════════════════════════════════════════
# CELDA 2B: VERIFICACIÓN (ejecutar DESPUÉS del reinicio)
# ═══════════════════════════════════════════════════════════════════════
...
try:
    ...
    if not np.__version__.startswith('1.'):
        print("   ⚠️ ADVERTENCIA: NumPy 2.x detectado")
        print("   Ejecuta la celda 2 nuevamente")
    else:
        print("   🎉 NumPy 1.x correcto")
...
try:
    ...
    print(f"❌ Error con PaddlePaddle: {e}")
...
print("\n" + "=" * 70)
print("✅ TODO LISTO - Puedes continuar con la celda 3")
print("=" * 70)

# ═══════════════════════════════════════════════════════════════════════
# PASO 3: INICIALIZAR OCR (compatible con PaddleOCR 3.3.2)
# ═══════════════════════════════════════════════════════════════════════
...
# Configuración para PaddleOCR 3.x (versión más nueva)
ocr_engine = PaddleOCR(lang='es')

print("\n✅ Motor OCR listo")
print("   🇪🇸 Idioma: Español")
print("   🎯 Versión 3.3.2 (más reciente)")
